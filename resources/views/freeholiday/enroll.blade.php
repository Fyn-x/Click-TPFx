...
<head>
    ...
    <title>TPFx - Free Holiday Enrollment</title>
    <!--====== Favicon Icon ======-->
                    ...
                    <div class="row align-items-center justify-content-center">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="booking-form wow fadeInUp ml-xl-3">
                                <h4 class="form-title text-center">Free Holiday Enrollment</h4>
                                <form id="leadsForm" role="form" method="POST"
                                    action="{{ route('freeholiday.enroll_store') }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label for="deposit">Sumber Iklan</label>
                                        <input type="text" class="form-control" id="source" name="source" value="{{ old('source') }}"
                                            placeholder="Ex: Google/Facebook/Pribadi" required>
                                    </div>
                                    <div class="form-group">

                    ...
                    <div class="row h-100">
                        <div class="col-12 text-center h-100 d-flex align-items-center justify-content-center">
                            <div><img class="img-fluid d-block mb-5 mx-auto"
                                ...
                                <a target="_blank" href="{{ asset('public/assets/tpfx-ebook-baru.pdf') }}"
                                    class="btn btn-warning my-4 me-1 me-sm-4 mx-auto text-center">DOWNLOAD E-BOOK</a>
                                <p>Silakan klik <a target="_blank" href="https://www.tpfx.co.id">link</a> berikut untuk

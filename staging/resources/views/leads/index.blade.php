<link href="{{asset('public/assets/leads/css/style.css')}}" rel="stylesheet" />
    ...
    <script src="{{asset('public/assets/leads/plugins/bootstrap/js/popper.min.js')}}"></script>
    <script src="{{asset('public/assets/leads/plugins/bootstrap/js/bootstrap.min.js')}}"></script>
<head>

...
class EventController extends Controller
{
    ...
    public function upload_leads(Request $request)
    {
        ...
        $importData_arr = Excel::toArray(new LeadsImport, $filepath)[0];
        ...
        foreach ($importData_arr as $key => $lead) {
            ...
            $this->store_leads($req_obj, $key + 1);
        }
    ...
    public function leads_form(Request $request)
    {
        ...
        switch ($utm_campaign) {
            ...
            case 'bigdeal':
                ...
                $section_4_description_1 = 'Raih peluang profit harian emas online di pasar paling likuid';
                $section_4_subheading_2 = 'Leverage';
                $section_4_description_2 = 'Transaksi dengan posisi besar hingga 100x menggunakan dana deposit yang rendah';
                $section_4_subheading_3 = 'Transaksi 2 Dua Arah';
                $section_4_description_3 = 'Transaksi yang memanfaatkan transaksi 2 arah baik beli dan jual';
            ...
            case 'ebook':
                ...
                switch ($utm_source) {
                    ...
                    case 'twitter':
                        ...
                        break;
                    case 'compro':
                        $source = 'compro banner ebook';
                        break;
                    case 'ebookpage':
                        $source = 'ebookpage banner ebook';
                        break;
                }
                break;
            case 'organik':
            ...
            case 'stars':
                $download_button = 'Daftar Year End Stars';
                $title = 'TPFx Year End Stars';

                $form_heading = 'Daftar Year End Stars Gratis';
                $form_subheading = '';

                $section_1_heading = 'TPFx Year End Stars';
                $section_1_subheading = 'Buka Akun Live sekarang langsung bisa ikutan TPFx Year End Stars gratis. Hanya dengan transaksi sebanyak-banyaknya Kamu bisa mendapatkan Hadiah Impian Gratis tanpa diundi.';
                $section_1_row_heading = '';

                $banner_image_desktop = 'stars-desktop-v1.jpg';
                $banner_image_mobile = 'stars-mobile-v1.jpg';
                ...
                switch ($utm_source) {
                    case 'google':
                        switch ($utm_medium) {
                            case 'video':
                                $source = 'google video stars';
                                break;
                            case 'banner':
                                $source = 'google banner stars';
                                break;
                            case 'search':
                                $source = 'google search stars';
                                break;
                            case 'keyword':
                                $source = 'google keyword stars';
                                break;
                        }
                        break;
                    case 'meta':
                        switch ($utm_medium) {
                            case 'form':
                                $source = 'meta form stars';
                                break;
                            case 'banner':
                                $source = 'meta lp-stars stars';
                                break;
                        }
                        break;
                    case 'tiktok':
                        $source = 'tiktok video stars';
                        break;
                    case 'ig-story':
                        $source = 'ig-story banner stars';
                        break;
                    case 'ig-bio':
                        $source = 'ig-bio link stars';
                        break;
                    case 'live-chat':
                        $source = 'live-chat link stars';
                        break;
                    case 'email':
                        $source = 'email news stars';
                        break;
                    case 'ig-dm':
                        $source = 'ig-dm link stars';
                        break;
                    case 'jurnal':
                        $source = 'jurnal article stars';
                        break;
                    case 'media':
                        $source = 'media rilis stars';
                        break;
                    case 'popupbanner':
                        $source = 'popupbanner banner stars';
                        break;
                    case 'page-stars':
                        $source = 'page-stars content stars';
                        break;
                    case 'sliderhomepage':
                        $source = 'sliderhomepage video stars';
                        break;
                }
                break;

            case 'reward-emas':
                $download_button = 'Daftar Reward Emas';
                $title = 'TPFx Reward Emas';

                $form_heading = 'Daftar Reward Emas Gratis';
                $form_subheading = '';

                $section_1_heading = 'TPFx Reward Emas';
                $section_1_subheading = 'Buat Lebaran Anda Makin Berkilauan Berkah. Yuk, ikuti program Semarak Lebaran  bersama TPFx.';
                $section_1_row_heading = '';

                $banner_image_desktop = 'gold-desktop.jpg';
                $banner_image_mobile = 'gold-mobile-v1.jpg';
                ...
                switch ($utm_source) {
                    case 'google':
                        switch ($utm_medium) {
                            case 'video':
                                $source = 'google video reward-emas';
                                break;
                            case 'banner':
                                $source = 'google banner reward-emas';
                                break;
                            case 'search':
                                $source = 'google search reward-emas';
                                break;
                            case 'keyword':
                                $source = 'google searchsearchsearchsearchsearch reward-emas';
                                break;
                        }
                        break;
                    case 'meta':
                        switch ($utm_medium) {
                            case 'form':
                                $source = 'meta form reward-emas';
                                break;
                            case 'banner':
                                $source = 'meta lp-reward reward-emas';
                                break;
                        }
                        break;
                    case 'tiktok':
                        $source = 'tiktok video reward-emas';
                        break;
                    case 'ig-story':
                        $source = 'ig-story banner reward-emas';
                        break;
                    case 'ig-bio':
                        $source = 'ig-bio link reward-emas';
                        break;
                    case 'live-chat':
                        $source = 'live-chat link reward-emas';
                        break;
                    case 'email':
                        $source = 'email news reward-emas';
                        break;
                    case 'ig-dm':
                        $source = 'ig-dm link reward-emas';
                        break;
                    case 'jurnal':
                        $source = 'jurnal article reward-emas';
                        break;
                    case 'media':
                        $source = 'media rilis reward-emas';
                        break;
                    case 'popupbanner':
                        $source = 'popupbanner banner reward-emas';
                        break;
                    case 'webcompro':
                        $source = 'webcompro banner reward-emas';
                        break;
                    case 'sliderhomepage':
                        $source = 'sliderhomepage video reward-emas';
                        break;
                    case 'jurnal':
                        $source = 'jurnal video reward-emas';
                        break;
                }
                break;
            ...
            case 'micro':
                $download_button = 'Daftar Sekarang';
                $title = 'TPFx Micro Lot';

                $form_heading = 'Buka Akun Sekarang';
                $form_subheading = '';

                $section_1_heading = 'Deposit Mulai 100rb Trading Micro 0,01 Lot';
                $section_1_subheading = 'Revolusi trading yang lebih terjangkau dengan mudah dan aman bersama broker lokal teregulasi di Indonesia. Buka akun live dan mulai trading sekarang.';
                $section_1_row_heading = '';

                $banner_image_desktop = 'micro-desktop-fix.jpg';
                $banner_image_mobile = 'micro-mobile-fix1.jpg';
                ...
                switch ($utm_source) {
                    case 'google':
                        switch ($utm_medium) {
                            case 'video':
                                $source = 'google video micro';
                                break;
                            case 'banner':
                                $source = 'google banner micro';
                                break;
                            case 'search':
                                $source = 'google search micro';
                                break;
                            case 'keyword':
                                $source = 'google keyword micro';
                                break;
                        }
                        break;
                    case 'meta':
                        switch ($utm_medium) {
                            case 'form':
                                $source = 'meta form micro';
                                break;
                            case 'banner':
                                $source = 'meta lp-stars micro';
                                break;
                        }
                        break;
                    case 'jurnal':
                        switch ($utm_medium) {
                            case 'article':
                                $source = 'jurnal article micro';
                                break;
                            case 'banner':
                                $source = 'jurnal banner micro';
                                break;
                        }
                        break;
                    case 'sliderhomepage':
                        switch ($utm_medium) {
                            case 'video':
                                $source = 'sliderhomepage video micro';
                                break;
                            case 'banner':
                                $source = 'sliderhomepage banner micro';
                                break;
                        }
                        break;
                    case 'tiktok':
                        $source = 'tiktok video micro';
                        break;
                    case 'ig-bio':
                        $source = 'ig-bio link micro';
                        break;
                    case 'live-chat':
                        $source = 'live-chat link micro';
                        break;
                    case 'email':
                        $source = 'email news micro';
                        break;
                    case 'ig-dm':
                        $source = 'ig-dm link micro';
                        break;

                    case 'media':
                        $source = 'media rilis micro';
                        break;
                    case 'popupbanner':
                        $source = 'popupbanner banner micro';
                        break;
                }
                break;
...
Kini anda dapat menikmati trading tanpa biaya inap, tanpa komisi dan juga kondisi spread yang stabil';
            ...
            case 'influencer':
                ...
                $section_1_heading = 'Awali Langkah Trading Tanpa Khawatir';
                $section_1_subheading = 'Mulai perjalanan trading dengan TPFx Indonesia. Beragam fasilitas dan edukasi untuk pemula, ciptakan cara trading yang menyenangkan';
                $section_1_row_heading = 'Maksimalkan transaksi anda dengan kesempatan trading menggunakan akun bebas biaya. Trading nyaman tanpa khawatir biaya tersembunyi';
                ...
                switch ($utm_source) {
                    case 'ig':
                        $source = 'ig video influencer';
                        break;
                    case 'tiktok':
                        $source = 'tiktok video influencer';
                        break;
                }
                break;
            ...
            case 'programmatic':
                ...
                switch ($utm_source) {
                    case 'optima':
                        switch ($utm_medium) {
                            case 'video':
                                $source = 'optima video programmatic';
                                break;
                            case 'banner':
                                $source = 'optima banner programmatic';
                                break;
                        }
                        break;
                }
                    ...
                    case 'google':
                        switch ($utm_medium) {
                            case 'banner':
                                ...
                                break;
                            case 'bilateral':
                                $source = 'google bilateral mediaplacement';
                                break;
                        }
                        break;
                }
...
Kini anda dapat menikmati trading tanpa biaya inap, tanpa komisi dan juga kondisi spread yang stabil';
            ...
            case 'google':
                switch ($utm_medium) {
                    case 'mahadana':
                        $source = 'google mahadana searchkompetitor';
                        break;
                    case 'monex':
                        $source = 'google monex searchkompetitor';
                        break;
                    case 'solidgold':
                        $source = 'google solidgold searchkompetitor';
                        break;
                    case 'fxpro':
                        $source = 'google fxpro searchkompetitor';
                        break;
                    case 'dinamis':
                        $source = 'google dinamis searchkompetitor';
                        break;
                    case 'asiapro':
                        $source = 'google asiapro searchkompetitor';
                        break;
                    case 'didimax':
                        $source = 'google didimax searchkompetitor';
                        break;
                    case 'display':
                        $source = 'google display searchkompetitor';
                        break;
                }
                break;
            ...
            case 'linktree':
                switch ($utm_medium) {
                    case 'link':
                        $source = 'linktree link bukaakunreal';
                        break;
                }
                break;
            ...
            case 'google':
                $source = 'google sitelink sitelink';
                break;
            ...
            case 'webcompro':
                $source = 'webcompro slidebanner zero';
                break;
            case 'jurnal':
                $source = 'jurnal slidebanner zero';
                break;
